...
#fc-side .tip{display:flex;align-items:flex-start;gap:8px;margin:0 0 4px;padding:8px 10px 9px;border:1px solid #e2dfd6;border-radius:6px;background:#fff;font-size:12px;line-height:1.45;color:#3d3b36}#fc-side .tip .tipbody{flex:1}#fc-side .tip b{display:block;margin:0 0 4px;color:#1c1b18}#fc-side .tip .grid{display:grid;grid-template-columns:auto 1fr;gap:3px 10px;align-items:center;font-size:12px;color:#3d3b36}#fc-side .tip .grid span:nth-child(odd){white-space:nowrap}#fc-side .tip .x{margin-left:auto;border:0;background:transparent;color:#8a877f;font-size:14px;line-height:1;padding:0 2px}#fc-side .tip .x:hover{color:#1c1b18}\
...
';
  ...
  function renderTop() {
    ...
    h += '<button class="kbdlink" data-act="shortcuts" title="Keyboard shortcuts (?)">Shortcuts <kbd>?</kbd></button>';
  ...
  function renderList() {
    ...
    h += '</div>';
    if (!tipSeen()) h += '<div class="tip"><div class="tipbody"><b>Keyboard shortcuts</b><div class="grid"><span><kbd>J</kbd> <kbd>K</kbd></span><span>Next / previous issue</span><span><kbd>1</kbd></span><span>Queue the edit</span><span><kbd>2</kbd></span><span>Dismiss</span><span><kbd>?</kbd></span><span>All shortcuts</span></div></div><button class="x" data-act="tipdone" title="Got it">×</button></div>';
    h += '</div>';
    h += '<div class="scroll">';
