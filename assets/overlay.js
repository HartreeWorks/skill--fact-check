...
';
  ...
  function renderList() {
    ...
    h += '</div>';
    if (!tipSeen()) h += '<div class="tip"><span><b>Keyboard shortcuts</b><br><kbd>J</kbd> and <kbd>K</kbd> move between issues, <kbd>1</kbd> queues the edit, <kbd>2</kbd> dismisses. Press <kbd>?</kbd> for all shortcuts.</span><button class="x" data-act="tipdone" title="Got it">×</button></div>';
    h += '</div>';
    h += '<div class="scroll">';
